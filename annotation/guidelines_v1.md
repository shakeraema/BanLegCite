# BanLegit-Cite: Legal Citation Annotation Guidelines (v1.0)
### Owner: Ema (Researcher A)

This document contains the guidelines for annotating legal citation fabrications in Bangladeshi statutes and case law. It provides the protocol, category definitions, worked examples, and edge-case resolution procedures.
